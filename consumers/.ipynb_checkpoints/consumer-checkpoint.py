...
class KafkaConsumer:
    ...
    def on_assign(self, consumer, partitions):
        ...
        # `offset_earliest` set the partition offset to the beginning or earliest 
    ...
    def _consume(self):
        ...
        # Additionally, make sure you return 1 when a message is processed,
        # and 0 when no message is retrieved. 
        try:
